...
import { UpsellPrediction } from './UpsellPrediction';
    ...
    <div className="space-y-8">
      ...
      <div ref={dashboardRef} className="bg-gray-50 p-8 min-h-screen space-y-8">
        <div className="mb-8">
          ...
          />
          <h1 className="text-xl font-medium text-gray-600 mt-2">企业版 2.0 高级账号测算报告</h1>
        ...
        {/* Budget Calculator */}
        <BudgetCalculator totalAdvancedCreators={analysis.highImpactCreators} />

        {/* Upsell Prediction */}
        <UpsellPrediction 
          monthlyTrends={analysis.trends.monthly} 
          currentAdvancedCount={analysis.highImpactCreators} 
        />
